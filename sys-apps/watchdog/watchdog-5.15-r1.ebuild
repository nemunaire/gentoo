...
PATCHES=(
	"${FILESDIR}/watchdog-5.15-Include-linux-param.h-for-EXEC_PAGESIZE-definition.patch"
	"${FILESDIR}/watchdog-5.14-5.15-Compile-with-musl-when-nfs-is-disabled.patch"
)
